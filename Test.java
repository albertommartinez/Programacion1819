...
class Test {
	...
	public static void main(String[] args) {
		...
		System.out.print("Valor a sumar y restar a las horas> ");
		hh = Teclado.nextInt();
		System.out.print("Valor a sumar y restar a los minutos> ");
		mm = Teclado.nextInt();
		System.out.print("Valor a sumar y restar a los segundos> ");
		ss = Teclado.nextInt();
